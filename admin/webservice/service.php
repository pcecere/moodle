...
if ($action == 'delete' and confirm_sesskey() and $service and empty($service->component)) {
    ...
    add_to_log($SITE->id, 'webservice', 'delete', $returnurl, get_string('deleteservice', 'webservice', $service));
    redirect($returnurl);
}
...
if ($mform->is_cancelled()) {
    ...
    if (empty($servicedata->id)) {
        ...
        add_to_log($SITE->id, 'webservice', 'add', $returnurl, get_string('addservice', 'webservice', $servicedata));
        ...
        add_to_log($SITE->id, 'webservice', 'edit', $returnurl, get_string('editservice', 'webservice', $servicedata));
    }
